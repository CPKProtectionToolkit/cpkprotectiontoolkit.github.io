(function () {
  ...
  "en": {
    ...
    "pricing.pes.ultimate.features": "<li>Licensing system</li>\n\t\t\t\t\t\t\t\t<li>Patch Installer system</li>\n\t\t\t\t\t\t\t\t<li>Encryption for CPK files</li>\n\t\t\t\t\t\t\t\t<li>Encryption for following Sider assets: BIN, FTEX, FPK, FPKD, FDC, USM, MP3, TXT, LUA, EDIT00000000</li>",
  ...
  "es": {
    ...
    "pricing.meta.oneYear": "licencia de 1 año",
    "pricing.plan.pes.standard": "Estándar",
    "pricing.plan.pes.pro": "Pro",
    "pricing.plan.pes.ultimate": "Suscripción",
    ...
    "pricing.pes.ultimate.features": "<li>Sistema de licencias</li><li>Sistema de instalador de parches</li><li>Cifrado de archivos CPK</li><li>Cifrado de los siguientes recursos de Sider: BIN, FTEX, FPK, FPKD, FDC, USM, MP3, TXT, LUA, EDIT00000000</li>",
  ...
  "id": {
    ...
    "pricing.meta.oneYear": "lisensi 1 tahun",
    "pricing.plan.pes.standard": "Standar",
    "pricing.plan.pes.pro": "Pro",
    "pricing.plan.pes.ultimate": "Berlangganan",
    ...
    "pricing.pes.ultimate.features": "<li>Sistem lisensi</li><li>Sistem installer patch</li><li>Enkripsi file CPK</li><li>Enkripsi untuk aset Sider berikut: BIN, FTEX, FPK, FPKD, FDC, USM, MP3, TXT, LUA, EDIT00000000</li>",
  ...
  "zh-Hans": {
    ...
    "pricing.meta.oneYear": "1 年许可证",
    "pricing.plan.pes.standard": "标准版",
    "pricing.plan.pes.pro": "专业版",
    "pricing.plan.pes.ultimate": "订阅",
    "pricing.meta.pesUltimate": "订阅 • $500 初始费用（一次性）",
    "pricing.meta.pesInstaller": "Pro 和 Ultimate 档位均包含适用于你补丁的自定义安装程序（含授权系统）。",
    "pricing.pes.standard.features": "<li>授权系统</li><li>CPK 文件加密</li>",
    "pricing.pes.pro.features": "<li>授权系统</li><li>补丁安装器系统</li><li>CPK 文件加密</li><li>以下 Sider 资源加密：MP3、TXT、LUA</li>",
    "pricing.pes.ultimate.features": "<li>授权系统</li><li>补丁安装器系统</li><li>CPK 文件加密</li><li>以下 Sider 资源加密：BIN、FTEX、FPK、FPKD、FDC、USM、MP3、TXT、LUA、EDIT00000000</li>",
