(function () {
  ...
  const translations = {
    "en": {
      ...
      "products.cpkpt.intro": "<span style=\"font-family:'Segoe UI Emoji'; color:#004dbb\">ℹ️</span> Protect your CPK files from unauthorized access with a dedicated, purpose-built toolkit <span style=\"font-family:'Segoe UI Emoji'; color:#ff0000\">❗️</span>",
      "products.cpkpt.benefitsIntro": "<span style=\"font-family:'Segoe UI Emoji'; color:#004dbb\">ℹ️</span> Key advantages include:",
      "products.cpkpt.b1": "<span style=\"font-family:'Segoe UI Symbol'; color:#ff0000\">👉</span> High-performance file processing",
      "products.cpkpt.b2": "<span style=\"font-family:'Segoe UI Symbol'; color:#ff0000\">👉</span> No practical file-size limitations",
      "products.cpkpt.b3": "<span style=\"font-family:'Segoe UI Symbol'; color:#ff0000\">👉</span> Enhanced security (built by practitioners experienced in analyzing locked CPKs—see <b>ULTIMATE CPK Unlocker</b> for context.)",
      ...
      "products.cpkpt.b5": "<span style=\"font-family:'Segoe UI Symbol'; color:#ff0000\">👉</span> Clean and safe (engineered to avoid false positives and optimized for reliability)",
      "products.cpkpt.b6": "<span style=\"font-family:'Segoe UI Symbol'; color:#ff0000\">👉</span> High-DPI friendly—looks sharp on 1440p and 4K displays",
      "products.cpkpt.b7": "<span style=\"font-family:'Segoe UI Symbol'; color:#ff0000\">👉</span> No monthly subscription. CPK Protection Toolkit offers a lifetime license at a fair price <span style=\"font-family:'Segoe UI Emoji'; color:#ff0000\">❗️</span> <i>(Note: Standard Edition only.)</i>",
